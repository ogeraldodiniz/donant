...
export default function Auth() {
  ...
  const titles: Record<AuthView, { h1: string; sub: string }> = {
    login: { h1: "Bem-vindo de volta!", sub: "Entre para continuar doando" },
    signup: { h1: "Crie sua conta", sub: "Comece a fazer a diferença hoje" },
    forgot: { h1: "Esqueceu a senha?", sub: "Enviaremos um link para redefinir" },
  };
  ...
  return (
    <div className="container py-12 max-w-md">
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-black">{titles[view].h1}</h1>
        <p className="text-muted-foreground text-sm mt-1">{titles[view].sub}</p>
      </div>
